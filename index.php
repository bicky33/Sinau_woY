...
<html lang="en">
  ...
  <body>
    ...
    <nav class="navbar navbar-light bg-white mid" style=" height: 65px">
        <!-- Logo -->
        <a class="navbar-brand no-mp" href="index.html">
          <img src="images/logo.png" width="100px" style="margin-top: 10px">
        </a>
